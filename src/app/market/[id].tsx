...
export default function Market(){
    ...
    const [couponIsFetching, setCouponIsFecthing] = useState(false)
    ...
    async function getCoupon(id: string){
        try {
            ...
            console.log(error)
            Alert.alert("Erro", "Não foi possível utilzar o cupom")
        }finally{
            setCouponIsFecthing(false)
        }
    }
